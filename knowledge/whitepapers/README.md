...
See [`TODO.md`](../../TODO.md) at the repository root for the full scope of `rating-and-progression.md`.
...
See [`TODO.md`](../../TODO.md) at the repository root for the full scope of `practice-methodology.md`.
