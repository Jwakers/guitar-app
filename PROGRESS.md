...
- [x] **Redefine difficulty 1–10 (intermediate start → mastery)** — 1–3 starting band; 5–6 advanced; 7–8 stretch; 9–10 basic mastery (rare). Updated prompts, inference, session bands, docs; one-shot remapped existing catalog; removed `devReset`.
