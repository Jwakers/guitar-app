...
- Prefer starting from `npx create-convex@1.42.1 --component` when possible
...
1. `npx convex@1.42.1 codegen --component-dir ./path/to/component`
2. Run the package build command
3. Run `npx convex@1.42.1 dev --typecheck-components` in the example app
